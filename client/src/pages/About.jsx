...
const timeline = [
  ...
  ['2021', 'First 100 Customers Served', 'Quality work, honest pricing, and the 3-month warranty made customers return and refer.'],
...
const values = [
  ...
  [ShieldCheck, 'Warranty Always', '3-month warranty on every completed job. If it fails, we fix it.'],
]
...
const howItWorks = [
  ...
  ['4', 'Done + 3M Warranty', 'Work completed. A 3-month warranty certificate is issued on every repair.'],
]
...
const whyChoose = [
  ...
  [ShieldCheck, '3-Month Warranty', 'Every completed repair comes with a 3-month warranty backed by our word.'],
]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="DP Home Electric Services - Founded by Manepalli Dilip Kumar, a Manchian Engineering graduate turned entrepreneur. Trusted electricians in Tuni, AP with 3-month warranty."
        />
      </Helmet>
      ...
      <main className="bg-surface">
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_1.15fr]">
            ...
            <div className="card p-8">
              ...
              {[
                ...
                'Today, DP Home Electric Services serves hundreds of families across Tuni and nearby areas. Every job comes with a 3-month warranty, transparent pricing, and the same personal care that Dilip showed on his very first assignment.',
              ].map((para) => (
        ...
        <section className="px-4 pb-16 sm:px-6">
          <div className="mx-auto max-w-7xl rounded-3xl bg-primary p-10 text-center shadow-amber">
            ...
            <p className="mt-2 text-sm text-white/85">Same-day service in Tuni. 3-month warranty guaranteed.</p>
